' Stops the hidden FTPortal.ps1 process started by StartPortalHidden.vbs.
...
If Not fso.FileExists(pidFile) Then
    MsgBox "portal.pid not found - portal isn't running (or wasn't started via StartPortalHidden.vbs).", vbExclamation, "FTPortal"
    WScript.Quit 1
End If
...
MsgBox "Portal stopped (PID " & pid & ") and the access point was shut down.", vbInformation, "FTPortal"
